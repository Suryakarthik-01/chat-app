            ...
            <div className='flex flex-col'>
                {filteredUsers.map((user, index) => (
                    ...
                    >
                        ...
                        {unseenMessages[user._id] > 0 && <p className='absolute top-4 right-4 text-sx h-5 w-5 flex justify-center items-center rounded-full bg-violet-500/50'>{unseenMessages[user._id]}</p>}
                    </div>
                ))}
